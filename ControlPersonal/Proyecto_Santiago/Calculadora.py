...
campo_entrada = tk.Entry(ventana, textvariable=entrada, font=("Arial", 28), bd=10, insertwidth=2, width=22, borderwidth=4, justify="right")
campo_entrada.grid(row=0, column=0, columnspan=6, pady=20)

# Lista de botones (texto, fila, columna, columna_span)
botones = [
